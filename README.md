...
The proposed system analyses user health profiles, nutritional requirements, recipe metadata, and community-generated feedback to recommend recipes aligned with individual dietary goals. Unlike conventional systems, CenrAI generates understandable natural-language explanations describing why specific recipes are recommended. The platform additionally incorporates community interaction, adaptive learning, and ingredient substitution mechanisms to improve recommendation quality and practical usability over time.

The proposed framework aims to improve user trust, dietary awareness, and recommendation relevance while promoting healthier eating habits through explainable and community-aware recommendation strategies.
